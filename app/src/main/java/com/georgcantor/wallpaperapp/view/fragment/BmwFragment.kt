    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val scrollListener = object : EndlessScrollListener(gridLayoutManager) {
            override fun onLoadMore(page: Int, totalItemsCount: Int, view: RecyclerView) {
                viewModel.getWallhavenPictures(getString(R.string.bmw_request), page)
            }
        }
        ...
        refreshLayout.setOnRefreshListener {
            viewModel.getWallhavenPictures(getString(R.string.bmw_request), 1)
        ...
        with(viewModel) {
            ...
            getWallhavenPictures(getString(R.string.bmw_request), 1)
        }
    }
}
