...
public class FetchYellowTask extends AsyncTask<Void, Void, Pic> {
    ...
    public FetchYellowTask(Context context, AsyncResponse output, int index) {
    ...
    protected Pic doInBackground(Void... params) {
        ...
        Call<Pic> call;
        call = client.getYellowPic(index);
